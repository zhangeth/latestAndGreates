                ...
                for (const key in pathFile) {
                    if (pathFile.hasOwnProperty(key)) {
                        ...
                        if (String(fileData) !== "") {
                            ...
                            var fileBodyArr = dataArr[2].split(','); // encoded information
                            var fileBody = Buffer.from(fileBodyArr[1], 'base64');
                            debuglog("base64Data: " + fileBodyArr[1]);
                            debuglog("fileBody: " + fileBody);
